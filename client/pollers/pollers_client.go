...
*/
func (a *Client) PollersCurrentDataGet(params *PollersCurrentDataGetParams, authInfo runtime.ClientAuthInfoWriter) (*PollersCurrentDataGetNoContent, error) {
...
*/
func (a *Client) PollersDataGet(params *PollersDataGetParams, authInfo runtime.ClientAuthInfoWriter) (*PollersDataGetNoContent, error) {
	// TODO: Validate the params before sending
	if params == nil {
