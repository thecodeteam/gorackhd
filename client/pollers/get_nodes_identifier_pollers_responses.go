...
func (o *GetNodesIdentifierPollersReader) ReadResponse(response client.Response, consumer httpkit.Consumer) (interface{}, error) {
...
func (o *GetNodesIdentifierPollersOK) readResponse(response client.Response, consumer httpkit.Consumer, formats strfmt.Registry) error {
...
/*GetNodesIdentifierPollersNotFound
...
func (o *GetNodesIdentifierPollersNotFound) readResponse(response client.Response, consumer httpkit.Consumer, formats strfmt.Registry) error {
...
/*GetNodesIdentifierPollersDefault
...
func (o *GetNodesIdentifierPollersDefault) readResponse(response client.Response, consumer httpkit.Consumer, formats strfmt.Registry) error {
...
/*GetNodesIdentifierPollersOKBodyBody GetNodesIdentifierPollersOKBodyBody get nodes identifier pollers o k body body
