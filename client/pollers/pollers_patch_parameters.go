...
func (o *PollersPatchParams) WithContent(content *models.PartialPoller) *PollersPatchParams {
	o.SetContent(content)
	return o
}

// SetContent adds the content to the pollers patch params
func (o *PollersPatchParams) SetContent(content *models.PartialPoller) {
	o.Content = content
}
...
func (o *PollersPatchParams) WriteToRequest(r runtime.ClientRequest, reg strfmt.Registry) error {
	...
	if o.Content == nil {
		o.Content = new(models.PartialPoller)
	}
