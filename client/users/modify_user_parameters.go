...
func (o *ModifyUserParams) WithBody(body *models.PatchUserObj) *ModifyUserParams {
	o.SetBody(body)
	return o
}

// SetBody adds the body to the modify user params
func (o *ModifyUserParams) SetBody(body *models.PatchUserObj) {
	o.Body = body
}
...
func (o *ModifyUserParams) WriteToRequest(r runtime.ClientRequest, reg strfmt.Registry) error {
	...
	if o.Body == nil {
		o.Body = new(models.PatchUserObj)
	}
