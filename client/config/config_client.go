...
/*
ConfigPut patches server configuration

Modify the RackHD server configuration.
*/
func (a *Client) ConfigPut(params *ConfigPutParams, authInfo runtime.ClientAuthInfoWriter) (*ConfigPutOK, error) {
	// TODO: Validate the params before sending
	if params == nil {
