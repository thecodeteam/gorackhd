...
func (o *GetNodesIdentifierObmIdentifyReader) ReadResponse(response client.Response, consumer httpkit.Consumer) (interface{}, error) {
...
/*GetNodesIdentifierObmIdentifyOK
...
func (o *GetNodesIdentifierObmIdentifyOK) readResponse(response client.Response, consumer httpkit.Consumer, formats strfmt.Registry) error {
...
/*GetNodesIdentifierObmIdentifyNotFound
...
func (o *GetNodesIdentifierObmIdentifyNotFound) readResponse(response client.Response, consumer httpkit.Consumer, formats strfmt.Registry) error {
...
/*GetNodesIdentifierObmIdentifyDefault
...
func (o *GetNodesIdentifierObmIdentifyDefault) readResponse(response client.Response, consumer httpkit.Consumer, formats strfmt.Registry) error {
...
/*GetNodesIdentifierObmIdentifyOKBodyBody GetNodesIdentifierObmIdentifyOKBodyBody get nodes identifier obm identify o k body body
