...
func (o *PatchNodesIdentifierReader) ReadResponse(response client.Response, consumer httpkit.Consumer) (interface{}, error) {
...
func (o *PatchNodesIdentifierOK) readResponse(response client.Response, consumer httpkit.Consumer, formats strfmt.Registry) error {
...
func (o *PatchNodesIdentifierNotFound) readResponse(response client.Response, consumer httpkit.Consumer, formats strfmt.Registry) error {
...
func (o *PatchNodesIdentifierDefault) readResponse(response client.Response, consumer httpkit.Consumer, formats strfmt.Registry) error {
...
/*PatchNodesIdentifierOKBodyBody PatchNodesIdentifierOKBodyBody patch nodes identifier o k body body
