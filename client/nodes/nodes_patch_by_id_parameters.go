...
func (o *NodesPatchByIDParams) WithBody(body *models.PartialNode) *NodesPatchByIDParams {
	o.SetBody(body)
	return o
}

// SetBody adds the body to the nodes patch by Id params
func (o *NodesPatchByIDParams) SetBody(body *models.PartialNode) {
	o.Body = body
}
