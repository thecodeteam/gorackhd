...
type NodesPatchTagByIDOK struct {
	Payload NodesPatchTagByIDOKBodyBody
}
...
/*NodesPatchTagByIDOKBodyBody nodes patch tag by ID o k body body

swagger:model NodesPatchTagByIDOKBodyBody
*/
type NodesPatchTagByIDOKBodyBody interface{}
