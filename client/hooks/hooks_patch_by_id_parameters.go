...
func (o *HooksPatchByIDParams) WithBody(body *models.HookBase) *HooksPatchByIDParams {
	o.SetBody(body)
	return o
}

// SetBody adds the body to the hooks patch by Id params
func (o *HooksPatchByIDParams) SetBody(body *models.HookBase) {
	o.Body = body
}
