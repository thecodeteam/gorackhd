...
type HooksPostCreated struct {
	Payload HooksPostCreatedBodyBody
}
...
/*HooksPostCreatedBodyBody hooks post created body body

swagger:model HooksPostCreatedBodyBody
*/
type HooksPostCreatedBodyBody interface{}
