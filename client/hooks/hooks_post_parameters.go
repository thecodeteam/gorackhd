...
func (o *HooksPostParams) WithBody(body *models.HookPost) *HooksPostParams {
	o.SetBody(body)
	return o
}

// SetBody adds the body to the hooks post params
func (o *HooksPostParams) SetBody(body *models.HookPost) {
	o.Body = body
}
