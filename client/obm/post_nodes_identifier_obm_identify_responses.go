...
func (o *PostNodesIdentifierObmIdentifyReader) ReadResponse(response client.Response, consumer httpkit.Consumer) (interface{}, error) {
...
/*PostNodesIdentifierObmIdentifyCreated
...
func (o *PostNodesIdentifierObmIdentifyCreated) readResponse(response client.Response, consumer httpkit.Consumer, formats strfmt.Registry) error {
...
/*PostNodesIdentifierObmIdentifyNotFound
...
func (o *PostNodesIdentifierObmIdentifyNotFound) readResponse(response client.Response, consumer httpkit.Consumer, formats strfmt.Registry) error {
...
/*PostNodesIdentifierObmIdentifyDefault
...
func (o *PostNodesIdentifierObmIdentifyDefault) readResponse(response client.Response, consumer httpkit.Consumer, formats strfmt.Registry) error {
