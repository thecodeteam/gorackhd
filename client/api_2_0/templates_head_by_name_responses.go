...
type TemplatesHeadByNameOK struct {
	Payload TemplatesHeadByNameOKBodyBody
}
...
/*TemplatesHeadByNameOKBodyBody templates head by name o k body body

swagger:model TemplatesHeadByNameOKBodyBody
*/
type TemplatesHeadByNameOKBodyBody interface{}
