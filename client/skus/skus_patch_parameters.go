...
func (o *SkusPatchParams) WithBody(body *models.SkusUpsert) *SkusPatchParams {
	o.SetBody(body)
	return o
}

// SetBody adds the body to the skus patch params
func (o *SkusPatchParams) SetBody(body *models.SkusUpsert) {
	o.Body = body
}
