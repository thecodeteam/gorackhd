...
type SkusPutCreated struct {
	Payload SkusPutCreatedBodyBody
}
...
/*SkusPutCreatedBodyBody skus put created body body

swagger:model SkusPutCreatedBodyBody
*/
type SkusPutCreatedBodyBody interface{}
