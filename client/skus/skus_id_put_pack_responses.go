...
type SkusIDPutPackCreated struct {
	Payload SkusIDPutPackCreatedBodyBody
}
...
/*SkusIDPutPackCreatedBodyBody skus ID put pack created body body

swagger:model SkusIDPutPackCreatedBodyBody
*/
type SkusIDPutPackCreatedBodyBody interface{}
