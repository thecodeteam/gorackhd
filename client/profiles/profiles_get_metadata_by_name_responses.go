...
type ProfilesGetMetadataByNameOK struct {
	Payload ProfilesGetMetadataByNameOKBodyBody
}
...
/*ProfilesGetMetadataByNameOKBodyBody profiles get metadata by name o k body body

swagger:model ProfilesGetMetadataByNameOKBodyBody
*/
type ProfilesGetMetadataByNameOKBodyBody interface{}
