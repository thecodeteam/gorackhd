...
/* polymorph ipmi-obm-service_Obm config false */

/* polymorph ipmi-obm-service_Obm nodeId false */

/* polymorph ipmi-obm-service_Obm service false */
...
func (m *IPMIObmServiceObm) MarshalBinary() ([]byte, error) {
	if m == nil {
		return nil, nil
	}
...
func (m *IPMIObmServiceObm) UnmarshalBinary(b []byte) error {
	var res IPMIObmServiceObm
